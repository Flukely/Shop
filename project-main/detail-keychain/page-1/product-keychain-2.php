...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Moji</h1>
            ...
            <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a class="text-white" href="../../ourshop-keychain-01.php">Keychain</a>
                    </li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Moji</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="left-image">
                        <div class="owl-carousel header-carousel position-relative">
                            <div class="owl-carousel-item position-relative">
                                <img class="img-fluid" src="../../img/keychain/page-1/original/product-2-1.JPG" alt="">
                            </div>
                            <div class="owl-carousel-item position-relative">
                                <img class="img-fluid" src="../../img/keychain/page-1/original/product-2-2.JPG" alt="">
                            </div>
                            <div class="owl-carousel-item position-relative">
                                <img class="img-fluid" src="../../img/keychain/page-1/original/product-2-3.JPG" alt="">
                            </div>
                            <div class="owl-carousel-item position-relative">
                                <img class="img-fluid" src="../../img/keychain/page-1/original/product-2-4.JPG" alt="">
                            </div>
                            <div class="owl-carousel-item position-relative">
                                <img class="img-fluid" src="../../img/keychain/page-1/original/product-2-5.JPG" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    ...
                    <div class="mt-4">
                        ...
                        <pre class="mali-regular">น้องๆหน้าอ้วนนน น่ารัก น่ารักหยิกสุดๆ  
