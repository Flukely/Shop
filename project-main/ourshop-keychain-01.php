...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Keychain</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-white active" aria-current="page">Keychain</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-keychain\page-1\product-keychain-1.php"><img class="img-fluid"
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.9s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-keychain\page-1\product-keychain-3.php"><img class="img-fluid"
                                    src="img\keychain\page-1\product-3.jpg" alt=""></a>
                        </div>
                        <div class="text-center border border-5 border-light border-top-0 p-4">
