...
<body>
   ...
   <div class="container-fluid p-0 pb-5">
    <div class="position-relative">
        <img class="img-fluid" src="img/crochet-1.jpg" alt="">
        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
            style="background: rgba(240, 140, 177, 0.427);">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8 text-center">
                        <h5 class="text-white text-uppercase mb-3 animated slideInDown">Welcome To</h5>
                        <h1 class="display-3 text-white animated slideInDown mb-4">In a world of KAJANG Crochet
                            is my muse</h1>
                    </div>
                </div>
            </div>
...
<!-- accressories Example End-->

<!-- keychain Example Start-->
<div class="container-xxl py-3">
    <div class="container">
        <div class="section-title text-start">
