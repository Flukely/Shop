...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Flower</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-white active" aria-current="page">Flower</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="1.2s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-flowers\page-1\product-flower-4.php"><img class="img-fluid"
                                    src="img/flower/page-1/product-4.png" alt=""></a>
                        </div>
                        <div class="text-center border border-5 border-light border-top-0 p-4">
                            <h5 class="mb-0">Forgetmenot  1</h5>
                            <small>129 ฿</small>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-flowers\page-1\product-flower-5.php"><img class="img-fluid"
                                    src="img/flower/page-1/product-5.png" alt=""></a>
                        </div>
                        <div class="text-center border border-5 border-light border-top-0 p-4">
                            <h5 class="mb-0">Sun Blue 1</h5>
                            <small>299 ฿</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-flowers\page-1\product-flower-6.php"><img class="img-fluid"
                                    src="img/flower/page-1/product-6.png" alt=""></a>
                        </div>
                        <div class="text-center border border-5 border-light border-top-0 p-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.9s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-flowers\page-1\product-flower-7.php"><img class="img-fluid"
                                    src="img/flower/page-1/product-7.png" alt=""></a>
                        </div>
                        <div class="text-center border border-5 border-light border-top-0 p-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="1.2s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-flowers\page-1\product-flower-8.php"><img class="img-fluid"
                                    src="img/flower/page-1/product-8.png" alt=""></a>
                        </div>
                        <div class="text-center border border-5 border-light border-top-0 p-4">
        ...
        <div class="row trending">
            <div class="col-lg-12">
                <ul class="pagination">
                    ...
                    <li><a href="ourshop-flower-02.php">2</a></li>
                    <li><a href="ourshop-flower-02.php"> &gt; </a></li>
                </ul>
            </div>
        </div>
    </div>
