...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Tulip twist </h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a class="text-white"
                            href="../../ourshop-accessories-01.php">Accessories</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Tulip twist </li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="left-image">
                        <div class="owl-carousel header-carousel position-relative">
                            <div class="owl-carousel-item position-relative">
                                <img class="img-fluid" src="../../img\accessories\page-1\original\product-1.JPG" alt="">
                            </div>
                            <div class="owl-carousel-item position-relative">
                                <img class="img-fluid" src="../../img\accessories\page-1\original\product-1-2.JPG"
                                    alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 align-self-center">
                    ...
                    <div class="mt-4">
                        ...
                        <pre class="mali-regular">ที่คาดผมดอกทิวลิป น่ารักสดใสมากกก  
