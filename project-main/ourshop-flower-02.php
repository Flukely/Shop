...
<body>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-flowers\page-2\product-flower-1.php"><img class="img-fluid"
                                    src="img/flower/page-2/product-1.png" alt=""></a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-flowers\page-2\product-flower-3.php"><img class="img-fluid"
                                    src="img/flower/page-2/product-3.png" alt=""></a>
                        </div>
                        <div class="text-center border border-5 border-light border-top-0 p-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.9s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-flowers\page-2\product-flower-4.php"><img class="img-fluid"
                                    src="img/flower/page-2/product-4.png" alt=""></a>
                        </div>
                        <div class="text-center border border-5 border-light border-top-0 p-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="1.2s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative rounded-3">
                            <a href="detail-flowers\page-2\product-flower-5.php"><img class="img-fluid"
                                    src="img/flower/page-2/product-5.png" alt=""></a>
                        </div>
                        <div class="text-center border border-5 border-light border-top-0 p-4">
    ...
    <div class="container-sm ">
        <div class="row trending">
            <div class="col-lg-12">
                <ul class="pagination">
                    <li><a href="ourshop-flower-01.php"> &lt; </a></li>
                    <li><a href="ourshop-flower-01.php">1</a></li>
                    <li><a class="is_active" href="ourshop-flower-02.php">2</a></li>
                    <li><a href="#"> &gt; </a></li>
                </ul>
            </div>
        </div>
