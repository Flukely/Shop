...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Sunlit Memories</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-white active" aria-current="page">Sunlit Memories</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="left-image">
                            <img class="img-fluid" src="../../img/flower/page-2/origin/product-3.JPG" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 align-self-center">
                        <h2>Sunlit Memories</h2>
                        <span class="price">218 ฿</span>
                        <div class="mt-4">
                            <h4 class="mali-regular">รายละเอียด</h4>
                            <pre class="mali-regular">ความสดใสของดอกทานตะวันและความหวานซึ้งของดอกฟอร์เก็ตมีน็อต
ทานตะวัน 1 ก้าน ฟอร์เก็ตมีน็อต 2  ก้าน  
