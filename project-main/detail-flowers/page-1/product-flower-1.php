...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">FLODUCKY</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-white active" aria-current="page">FLODUCKY</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="left-image">
                            <img class="img-fluid" src="../../img/flower/page-1/origin/product-1.JPG" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 align-self-center">
                        ...
                        <div class="mt-4">
                            ...
                            <pre class="mali-regular">ใครที่ชอบเป่ดเป้ดเป็ด ช่อนี้ตอบโจทย์มาก น้องเป็นช่อโทนสีเหลืองสดใส
ในช่อประกอบด้วย เป็ด 1 ก้าน ทานตะวัน 2 ก้าน ฟอร์เก็ตมีน็อต 2 ก้าน
(หากต้องการเลือกสีเอง สามารถ IB ทางร้านได้เลยค่ะ)
                            </pre>
                        </div>
                    </div>
                </div>
